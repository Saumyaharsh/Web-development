...
// Node list and html collections are different
// Can't use foreach loop to iterate html collections
// you can use for loop
// Node list can be iterable using foreach 
// Nodelis is a static list and html collection is live
